import{_ as S}from"../chunks/C1FmrZbK.js";import{a as H,t as B}from"../chunks/BiLuL0hp.js";import"../chunks/AUOfbfJl.js";import{g as G,T as W,V as q,i as x,m as I,k as i,l as e,n as t,W as o,o as D,j as M}from"../chunks/BbpcrWHf.js";import{s as R}from"../chunks/BOHOHBMm.js";import{A as P,L as V,s as j}from"../chunks/CH9MClBd.js";import{i as U}from"../chunks/4MD7xXmO.js";import{o as b}from"../chunks/BiL4rTdE.js";import{b as $}from"../chunks/Cflg2fV5.js";import{A as z}from"../chunks/fE49oVNY.js";var Y=B(`<section id="hero"><div class="animated-header svelte-17ayhh9"><div>Understanding <br> the scale of<br> Emissions</div> <div class="ah1 svelte-17ayhh9"><!></div></div> <div class="content-container svelte-17ayhh9"><div class="paragraph-1 svelte-17ayhh9"><p class="lead svelte-17ayhh9">One reason that misconceptions about climate change gain traction is that the population
				generally has poor levels of understanding around the units we 
				...
				change in units that anyone can digest. This article is an attempt to
				to show how using this approach can drastically shift how we feel about
				...
				Perth.</p></div></div> <figure class="svelte-17ayhh9"><div id="infograph-1" class="svelte-17ayhh9"><img alt="Infographic" class="campaign-image svelte-17ayhh9"></div> <figcaption>Simple measurements showing ways to produce 1 tonne of CO2 (source:
			UtilitySmarts)</figcaption></figure> <div class="makeover-paragraph svelte-17ayhh9"><div class="paragraph-2 svelte-17ayhh9"><p class="svelte-17ayhh9">However, these 13 tonnes of CO2 represent a tiny fraction of the
				...
				emitters to produce the annual emissions of a single Australian.</p></div></div> <figure id="d3-chart" class="svelte-17ayhh9"><!> <figcaption>The time it takes for Australia's largest emitters to produce
			...
			year (source: WorldBank)</figcaption></figure> <div class="makeover-paragraph svelte-17ayhh9"><div class="paragraph-2 svelte-17ayhh9"><p class="svelte-17ayhh9">Since we are interested in the usefulness of carbon footprint
				...
				emissions output in Australia.</p></div></div> <figure id="d3-chart-lifetime" class="svelte-17ayhh9"><!> <figcaption>The time it takes for Australia's largest emitters to produce
			...
			their lifetime (source: WorldBank)</figcaption></figure> <div class="makeover-paragraph svelte-17ayhh9"><div class="paragraph-2 svelte-17ayhh9"><p class="svelte-17ayhh9">It may be disheartening to those who choose to forego simple
				...
				choices available to us in the first place.</p></div></div></section>`,1);function ie(A,k){G(k,!1);let u=D(!1);b(()=>{const d=document.querySelector(".title");if(d){const n=d.getBoundingClientRect().top,a=window.innerHeight;n<a*.75&&I(u,!0)}const s=()=>{const n=document.querySelectorAll(".fadein-scroll"),a=new Set;n.forEach((r,F)=>{if(a.has(r))return;const E=r.getBoundingClientRect().top,L=window.innerHeight;E<L*.5&&(r.classList.add("visible"),a.add(r),a.size===n.length&&window.removeEventListener("scroll",s))})};return window.addEventListener("scroll",s),s(),()=>{window.removeEventListener("scroll",s)}}),b(async()=>{typeof window<"u"&&(await S(()=>import("../chunks/CvEQ06TD.js").then(s=>s.l),[],import.meta.url)).default}),U();var p=Y(),l=W(p),m=e(l),v=e(m),f=i(v,2),_=e(f);z(_,{}),t(f),t(m),o(2),t(l);var g=i(l,2),h=i(e(g),2),y=e(h),C=e(y);R(C,"src",`${$??""}/infograph-1tco2.jpg`),t(y),o(2),t(h);var c=i(h,4),T=e(c);P(T,{}),o(2),t(c);var w=i(c,4),O=e(w);V(O,{}),o(2),t(w),o(2),t(g),q(()=>j(v,`title ${(M(u)?"visible":"")??""} svelte-17ayhh9`)),H(A,p),x()}export{ie as component};
