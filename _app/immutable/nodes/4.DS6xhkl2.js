import{_ as H}from"../chunks/C1FmrZbK.js";import{a as M,t as R}from"../chunks/DGqtx0UH.js";import"../chunks/BzWc-8pQ.js";import{g as D,T as O,V as L,i as N,m as W,l as e,n as t,k as i,W as P,o as F,j as q}from"../chunks/5lW7ABz8.js";import{s as g}from"../chunks/D0lOji1P.js";import{s as G}from"../chunks/Bjzgw3R-.js";import{i as J}from"../chunks/0IwTZHX3.js";import{o as z}from"../chunks/tLbPkKgv.js";import{b as p}from"../chunks/FRnDptaE.js";import{A as $}from"../chunks/Laa9MhVm.js";var V=R(`<section id="hero"><div class="animated-header svelte-8ygzyh"><div class="title-container svelte-8ygzyh"><h1>The <br> Aesthetics <br> of Inaction: <br> BP's Story</h1></div> <div class="ah1 svelte-8ygzyh"><!></div></div></section> <div class="content-container svelte-8ygzyh"><div class="paragraph-1 svelte-8ygzyh"><p class="lead svelte-8ygzyh">BPs green rebrand in the 2000s represented the company's shift
			...
			to decieve them.</p></div></div> <section id="s-origins" class="svelte-8ygzyh"><div class="makeover-paragraph svelte-8ygzyh"><div class="paragraph-2 svelte-8ygzyh"><p class="svelte-8ygzyh">In the 15 years leading to 2000, climate change went mainstream.
				...
				impending climate crises was reaching all time highs.</p> <figure class="bar-chart svelte-8ygzyh"><figcaption class="caption lead svelte-8ygzyh">Most people heard about climate change for the first time in
				...
				for change.</p> <figure class="bar-chart svelte-8ygzyh"><figcaption class="caption lead svelte-8ygzyh">Most people wanted to see something done about climate
					change without having a clear understanding of the science.</figcaption> <figcaption class="caption subcaption svelte-8ygzyh">Leiserowitz's "Six Americas" study (2008) found that
					consumers were motivated to see action on climate change,
					but lacked understanding of what causes and solutions would
					look like.</figcaption> <img alt="Bar chart of climate awareness increasing in the 2000s" class="bar-chart-img svelte-8ygzyh"></figure> <p class="svelte-8ygzyh">While other companies would flounder against the rising wave of
				...
				willing to be misled.</p> <h3 class="references svelte-8ygzyh">References</h3> <p class="svelte-8ygzyh">1) Nisbet, M. C., & Myers, T. A. (2007). The polls–trends:
				Twenty years of public opinion about global warming. Public
				Opinion Quarterly, 71(3), 444–470.</p> <p class="svelte-8ygzyh">2) Barrage, L., Chyn, E. and Hastings, J. (2020) ‘Advertising
				and Environmental Stewardship: Evidence from the BP oil spill’,
				American Economic Journal: Economic Policy, 12(1), pp. 33–61.
				doi:10.1257/pol.20160555.</p> <p class="svelte-8ygzyh">3) Carpenter, S. (2020) ‘After Abandoned “Beyond Petroleum”
				Re-brand, BP’s New Renewables Push Has Teeth’, Forbes, 4 August.</p> <p class="svelte-8ygzyh">4) Frick, W. (2014) ‘Study: Green Advertising Helped BP Recover
				from the Deepwater Horizon Spill’, Harvard Business Review, 6
				February.</p> <p class="svelte-8ygzyh">5) Leiserowitz, A. et al. (2021) ‘Global warming’s six Americas:
				A review and recommendations for climate change communication’,
				Current Opinion in Behavioral Sciences, 42, pp. 97–103.
				doi:10.1016/j.cobeha.2021.04.007.</p> <p class="svelte-8ygzyh">6) Nocera, J. (2006) ‘Green Logo, but BP Is Old Oil’, The New
				York Times, 12 August.</p> <p class="svelte-8ygzyh">7) Sweet, B. (2010) ‘BP Closes Another Solar Manufacturing
				Plant’, IEEE Spectrum, 2 April.</p> <p class="svelte-8ygzyh">8) BP. (2001). BP Annual Report 2001: Beyond Petroleum.
				Retrieved from BP archive.</p> <p class="svelte-8ygzyh">9) U.S. Chemical Safety Board. (2007). Investigation Report:
				Refinery Explosion and Fire. BP Texas City, Texas, March 23,
				2005.</p> <p class="svelte-8ygzyh">10) National Commission on the BP Deepwater Horizon Oil Spill
				and Offshore Drilling. (2011). Deep Water: The Gulf Oil Disaster
				and the Future of Offshore Drilling. U.S. Government Printing
				Office.</p></div></div></section>`,1);function se(k,A){D(A,!1);let u=F(!1);z(()=>{const d=document.querySelector(".title");if(d){const n=d.getBoundingClientRect().top,s=window.innerHeight;n<s*.75&&W(u,!0)}const a=()=>{const n=document.querySelectorAll(".fadein-scroll"),s=new Set;n.forEach((r,U)=>{if(s.has(r))return;const I=r.getBoundingClientRect().top,C=window.innerHeight;I<C*.5&&(r.classList.add("visible"),s.add(r),s.size===n.length&&window.removeEventListener("scroll",a))})};return window.addEventListener("scroll",a),a(),()=>{window.removeEventListener("scroll",a)}}),z(async()=>{typeof window<"u"&&(await H(()=>import("../chunks/CvEQ06TD.js").then(a=>a.l),[],import.meta.url)).default}),J();var m=V(),o=O(m),y=e(o),l=e(y),T=e(l);t(l);var f=i(l,2),_=e(f);$(_,{}),t(f),t(y),t(o);var v=i(o,4),w=e(v),b=e(w),c=i(e(b),2),S=i(e(c),4);g(S,"src",`${p??""}/colchart-climateawareness.png`),t(c);var h=i(c,4),E=e(h);g(E,"src",`${p??""}/BP_baby_ad.gif`),P(2),t(h);var B=i(h,8),x=i(e(B),4);g(x,"src",`${p??""}/six-americas.png`),t(B),P(32),t(b),t(w),t(v),L(()=>G(T,`title ${(q(u)?"visible":"")??""} svelte-8ygzyh`)),M(k,m),N()}export{se as component};
