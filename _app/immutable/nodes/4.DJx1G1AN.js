import{b as W,_ as z}from"../chunks/7f8r9I2t.js";import{a as G,t as K}from"../chunks/DXnFObDU.js";import"../chunks/CcuueaZQ.js";import{Z as U,_ as V,$ as Y,m as l,a0 as a,a1 as e,a2 as t,a3 as r,a4 as Z,a5 as J}from"../chunks/DD4mjsJM.js";import{s as c}from"../chunks/Z-HGXm5L.js";import{i as N}from"../chunks/Czb9bWix.js";import{o as F}from"../chunks/CMyLQ5eM.js";import{b as s}from"../chunks/BPM6Kjcs.js";import{P as Q}from"../chunks/BpqmTQF5.js";var ee=K(`<section id="hero"><div class="text-box svelte-1l5e9he"><div class="hero-animation"><div class="invertible svelte-1l5e9he"><div class="content-container svelte-1l5e9he"><div class="title svelte-1l5e9he">The Carbon <br> Footprint <br> Story</div> <img alt="Footprints" class="footprints svelte-1l5e9he"></div> <div class="black-rectangle svelte-1l5e9he"></div> <div class="content-container svelte-1l5e9he"><div class="paragraph-1 svelte-1l5e9he"><p class="lead svelte-1l5e9he">The idea of the Carbon footprint has put our
					...
					such as diet, transport and overseas travel.</p></div> <div class="pictures-2 svelte-1l5e9he"><figure class="svelte-1l5e9he"><img alt="BP's Advertising Campaign" class="campaign-image svelte-1l5e9he"> <figcaption>The original BP carbon campaign from 2005 (source: XXX)</figcaption></figure> <figure class="svelte-1l5e9he"><img alt="Early Carbon Footprint Calculator" class="campaign-image calc svelte-1l5e9he"> <figcaption>An early carbon footprint calculator (source: soft112)</figcaption></figure></div></div></section></div> <figure class="sticky-text svelte-1l5e9he"><img alt="Painting of a man's sillouette in smoke billowing from a smoke stack" class="smokestack-image svelte-1l5e9he"> <div class="perspective above svelte-1l5e9he">Putting Emissions Back in Perspective</div></figure> <section id="perspective" class="svelte-1l5e9he"><div class="content-container"><div class="content-box-2 svelte-1l5e9he"><div class="paragraph-2 light wht-brdr svelte-1l5e9he"><p class="svelte-1l5e9he">With a lack of accurate information, our collective sense of
					...
					have consequences on a large scale.</p></div> <div class="pictures-2 chart svelte-1l5e9he"><figure class="svelte-1l5e9he"><div id="lottie-animation" style="width: 100%; height: 500px;" class="svelte-1l5e9he"></div> <div class="caption-1 svelte-1l5e9he">Click on the chart to see your <br> emissions in
						...
						breakdown.</div></figure></div></div></div></section> <div class="content-container"><div class="project-grid svelte-1l5e9he"><!></div></div>`,1);function de(H,S){U(S,!1),F(()=>{document.addEventListener("scroll",function(){var D;const i=window.scrollY,n=window.innerHeight;(D=document.getElementById("hero"))==null||D.offsetHeight;const X=document.querySelector(".black-rectangle");let g=n-100-i/n*1e3;g<0&&(g=0),X.style.top=g+"px"})});let o=J(null),d;F(async()=>{if(typeof window<"u"&&(d=(await z(()=>import("../chunks/CvEQ06TD.js").then(n=>n.l),[],import.meta.url)).default),d&&l(o)){const i=d.loadAnimation({container:l(o),renderer:"svg",loop:!1,autoplay:!1,path:`${s}/perspective-v2.json`});i.setSpeed(.6),l(o).addEventListener("click",()=>{(i.isPaused||i.currentFrame===0)&&i.play()}),i.addEventListener("complete",()=>{i.playDirection===1?(i.goToAndStop(i.totalFrames,!0),i.setDirection(-1)):i.playDirection===-1&&i.setDirection(1)})}}),N();var f=ee(),h=V(f),b=e(h),w=e(b),y=e(w),_=e(y),q=a(e(_),2);c(q,"src",`${s??""}/footprints-transparent.png`),t(_),r(4),t(y),t(w),t(b),t(h);var v=a(h,2),k=e(v),x=a(e(k),2),T=a(e(x),2),p=e(T),L=e(p);c(L,"src",`${s??""}/bp-cf-ads.jpg`),r(2),t(p);var P=a(p,2),R=e(P);c(R,"src",`${s??""}/cfc-screenshot.jpg`),r(2),t(P),t(T),t(x),t(k),t(v);var m=a(v,2),I=e(m);c(I,"src",`${s??""}/smoke-stack-extended.jpg`),r(2),t(m);var u=a(m,2),C=e(u),A=a(e(C),2),E=a(e(A),2),j=e(E),M=e(j);W(M,i=>Z(o,i),()=>l(o)),r(2),t(j),t(E),t(A),t(C),t(u);var $=a(u,2),B=e($),O=e(B);Q(O,{link:`${s??""}/articles/article-two`,type:"row",imgUrl:`${s??""}/smoke-stack-extended.jpg`,cat:"Project",title:"Explore the Reverse Carbon Calculator",description:"An in-depth analysis of carbon emissions across various industries and their impact on the environment."}),t(B),t($),G(H,f),Y()}export{de as component};
