import{_ as C}from"../chunks/C1FmrZbK.js";import{a as H,t as M}from"../chunks/DGqtx0UH.js";import"../chunks/BzWc-8pQ.js";import{g as R,T as D,V as O,i as L,m as N,l as e,n as t,k as i,W as P,o as W,j as F}from"../chunks/5lW7ABz8.js";import{s as p}from"../chunks/D0lOji1P.js";import{s as G}from"../chunks/Bjzgw3R-.js";import{i as J}from"../chunks/0IwTZHX3.js";import{o as z}from"../chunks/tLbPkKgv.js";import{b as u}from"../chunks/D3BkOIJP.js";import{A as $}from"../chunks/Laa9MhVm.js";var V=M(`<section id="hero"><div class="animated-header svelte-qsozeo"><div class="title-container svelte-qsozeo"><h1>The <br> Aesthetics <br> of Inaction: <br> BP's Story</h1></div> <div class="ah1 svelte-qsozeo"><!></div></div></section> <div class="content-container svelte-qsozeo"><div class="paragraph-1 svelte-qsozeo"><p class="lead svelte-qsozeo">BPs green rebrand in the 2000s represented the company's shift
			...
			to decieve them.</p></div></div> <section id="s-origins" class="svelte-qsozeo"><div class="makeover-paragraph svelte-qsozeo"><div class="paragraph-2 svelte-qsozeo"><p class="svelte-qsozeo">In the 15 years leading to 2000, climate change went mainstream.
				...
				Office.</p></div></div></section>`,1);function ae(q,k){R(k,!1);let m=W(!1);z(()=>{const h=document.querySelector(".title");if(h){const o=h.getBoundingClientRect().top,a=window.innerHeight;o<a*.75&&N(m,!0)}const s=()=>{const o=document.querySelectorAll(".fadein-scroll"),a=new Set;o.forEach((n,U)=>{if(a.has(n))return;const x=n.getBoundingClientRect().top,I=window.innerHeight;x<I*.5&&(n.classList.add("visible"),a.add(n),a.size===o.length&&window.removeEventListener("scroll",s))})};return window.addEventListener("scroll",s),s(),()=>{window.removeEventListener("scroll",s)}}),z(async()=>{typeof window<"u"&&(await C(()=>import("../chunks/CvEQ06TD.js").then(s=>s.l),[],import.meta.url)).default}),J();var g=V(),r=D(g),f=e(r),l=e(f),A=e(l);t(l);var v=i(l,2),T=e(v);$(T,{}),t(v),t(f),t(r);var w=i(r,4),y=e(w),b=e(y),c=i(e(b),2),_=i(e(c),4);p(_,"src",`${u??""}/colchart-climateawareness.png`),t(c);var d=i(c,4),S=e(d);p(S,"src",`${u??""}/BP_baby_ad.gif`),P(2),t(d);var B=i(d,8),E=i(e(B),4);p(E,"src",`${u??""}/six-americas.png`),t(B),P(32),t(b),t(y),t(w),O(()=>G(A,`title ${(F(m)?"visible":"")??""} svelte-qsozeo`)),H(q,g),L()}export{ae as component};
