import{_ as C}from"../chunks/C1FmrZbK.js";import{a as H,t as L}from"../chunks/DGqtx0UH.js";import"../chunks/BzWc-8pQ.js";import{g as W,T as D,V as $,i as N,m as R,l as e,n as t,k as i,W as B,o as V,j as z}from"../chunks/5lW7ABz8.js";import{s as u}from"../chunks/D0lOji1P.js";import{s as O}from"../chunks/Bjzgw3R-.js";import{i as F}from"../chunks/0IwTZHX3.js";import{o as q}from"../chunks/tLbPkKgv.js";import{b as m}from"../chunks/W6LhIXPF.js";import{A as G}from"../chunks/Laa9MhVm.js";var J=L(`<section id="hero"><div class="animated-header svelte-q6hi1k"><div class="title-container svelte-q6hi1k"><div>The oil <br> marketing <br> campaign that <br> put an end <br> to climate denial</div></div> <div class="ah1 svelte-q6hi1k"><!></div></div></section> <div class="content-container svelte-q6hi1k"><div class="paragraph-1 svelte-q6hi1k"><p class="lead svelte-q6hi1k">Two decades ago, you would have been forgiven for thinking BP stood
			...
			when it suits our worldview to do so.</p></div></div> <section id="s-origins" class="svelte-q6hi1k"><div class="makeover-paragraph svelte-q6hi1k"><div class="paragraph-2 svelte-q6hi1k"><p class="svelte-q6hi1k">In the 15 years leading to 2000, climate change went mainstream.
				...
				Jackson's hair and clothes, had a cultural moment. Al Gore, a
				pro-environmental figurehead, achieved the popular vote for the
				US presidency in 2000 as public support for climate positive
				change swelled. Public awareness led extreme weather events to
				be associated with the greenhouse effect for the first time,
				further elevating its profile in public discussion. Extreme
				...
				impending climate crises was reaching all time highs.</p> <figure class="bar-chart svelte-q6hi1k"><figcaption class="caption lead svelte-q6hi1k">Most people heard about climate change for the first time in
				...
				they end up choosing.</p> <figure class="svelte-q6hi1k"><img alt="BP video ad"> <figcaption>BP's "Babies" TV ad was aired in 2007.</figcaption></figure> <p class="svelte-q6hi1k">BPs campaign was responding to the growing sentiment that fossil
				...
				pollution and hold out until people forgot all about it.</p> <p class="svelte-q6hi1k">BP realised that this strategy was deeply flawed. Denying their
				...
				Petroleum”.</p> <p class="svelte-q6hi1k">BP’s transformation resonated with consumers who were yet to
				understand climate change fully, but still felt strongly about
				it. Mason's seminal 2008 study found most consumers could be
				categorised as “Alarmed”, “Concerned” or “Cautious” regarding
				global warming; supportive of action, but unclear on causes or
				solutions. This lack of technical understanding gave strength to
				BP’s optics-driven approach, espousing the impression they were
				cutting back on damaging behaviour in response to public calls
				for change.</p> <figure class="bar-chart svelte-q6hi1k"><figcaption class="caption lead svelte-q6hi1k">Most people wanted to see something done about climate
					...
					understanding of the true drivers behind it.</figcaption> <img alt="Bar chart of climate awareness increasing in the 2000s" class="bar-chart-img svelte-q6hi1k"></figure> <p class="svelte-q6hi1k">While other companies would flounder against the rising wave of
				...
				viewed BP as “the most environmentally friendly oil company”.</p> <h2 class="svelte-q6hi1k">Not Beyond Credibility</h2> <p class="svelte-q6hi1k">While BP had become a dark horse of the green marketing world,
				...
				overhead expenses, even at the cost of necessary quality and
				safety protocols. Whilst initially contained, these oversights
				soon began to compound, culminating in a series of dramatic
				events that would shake the firm to its core.</p> <p class="svelte-q6hi1k">In 2005, a distillation tower at the Texas City oil refinery was
