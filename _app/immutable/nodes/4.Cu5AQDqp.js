import{_ as H}from"../chunks/C1FmrZbK.js";import{a as L,t as C}from"../chunks/DGqtx0UH.js";import"../chunks/BzWc-8pQ.js";import{g as D,T as W,V as $,i as R,m as V,l as e,n as t,k as i,W as P,o as z,j as N}from"../chunks/5lW7ABz8.js";import{s as m}from"../chunks/D0lOji1P.js";import{s as O}from"../chunks/Bjzgw3R-.js";import{i as F}from"../chunks/0IwTZHX3.js";import{o as k}from"../chunks/tLbPkKgv.js";import{b as u}from"../chunks/BxdMOoit.js";import{A as J}from"../chunks/Laa9MhVm.js";var j=C(`<section id="hero"><div class="animated-header svelte-ynmhwm"><div class="title-container svelte-ynmhwm"><h1>The <br> Aesthetics <br> of Inaction: <br> BP's Story</h1></div> <div class="ah1 svelte-ynmhwm"><!></div></div></section> <div class="content-container svelte-ynmhwm"><div class="paragraph-1 svelte-ynmhwm"><p class="lead svelte-ynmhwm">BPs green rebrand in the 2000s represented the companies shift "Beyond Petroleum". 
			...
			them.</p></div></div> <section id="s-origins" class="svelte-ynmhwm"><div class="makeover-paragraph svelte-ynmhwm"><div class="paragraph-2 svelte-ynmhwm"><p class="svelte-ynmhwm">In the 15 years leading to 2000, climate change went mainstream.
				...
				for change.</p> <figure class="bar-chart svelte-ynmhwm"><figcaption class="caption lead svelte-ynmhwm">Most people wanted to see something done about climate
					change without having a clear understanding of the science.</figcaption> <figcaption class="caption subcaption svelte-ynmhwm">George Mason's "Six Americas" study (2008) found that consumers were
					motivated to see action on climate change, but lacked
					understanding of what causes and solutions would look like.</figcaption> <img alt="Bar chart of climate awareness increasing in the 2000s" class="bar-chart-img svelte-ynmhwm"></figure> <p class="svelte-ynmhwm">While other companies would flounder against the rising wave of
				...
				willing to be misled.</p></div></div></section>`,1);function se(_,A){D(A,!1);let p=z(!1);k(()=>{const d=document.querySelector(".title");if(d){const n=d.getBoundingClientRect().top,s=window.innerHeight;n<s*.75&&V(p,!0)}const a=()=>{const n=document.querySelectorAll(".fadein-scroll"),s=new Set;n.forEach((r,G)=>{if(s.has(r))return;const M=r.getBoundingClientRect().top,q=window.innerHeight;M<q*.5&&(r.classList.add("visible"),s.add(r),s.size===n.length&&window.removeEventListener("scroll",a))})};return window.addEventListener("scroll",a),a(),()=>{window.removeEventListener("scroll",a)}}),k(async()=>{typeof window<"u"&&(await H(()=>import("../chunks/CvEQ06TD.js").then(a=>a.l),[],import.meta.url)).default}),F();var g=j(),o=W(g),f=e(o),l=e(f),T=e(l);t(l);var w=i(l,2),I=e(w);J(I,{}),t(w),t(f),t(o);var y=i(o,4),v=e(y),b=e(v),c=i(e(b),2),x=i(e(c),4);m(x,"src",`${u??""}/colchart-climateawareness.png`),t(c);var h=i(c,4),E=e(h);m(E,"src",`${u??""}/BP_baby_ad.gif`),P(2),t(h);var B=i(h,8),S=i(e(B),4);m(S,"src",`${u??""}/six-americas.png`),t(B),P(10),t(b),t(v),t(y),$(()=>O(T,`title ${(N(p)?"visible":"")??""} svelte-ynmhwm`)),L(_,g),R()}export{se as component};
