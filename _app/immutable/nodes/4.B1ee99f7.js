import{_ as H}from"../chunks/C1FmrZbK.js";import{a as L,t as C}from"../chunks/DGqtx0UH.js";import"../chunks/BzWc-8pQ.js";import{g as D,T as W,V as $,i as R,m as V,l as e,n as t,k as i,W as P,o as z,j as N}from"../chunks/5lW7ABz8.js";import{s as m}from"../chunks/D0lOji1P.js";import{s as O}from"../chunks/Bjzgw3R-.js";import{i as F}from"../chunks/0IwTZHX3.js";import{o as k}from"../chunks/tLbPkKgv.js";import{b as u}from"../chunks/B3_MyS5l.js";import{A as J}from"../chunks/Laa9MhVm.js";var j=C(`<section id="hero"><div class="animated-header svelte-ynmhwm"><div class="title-container svelte-ynmhwm"><h1>The <br> Aesthetics <br> of Inaction: <br> BP's Story</h1></div> <div class="ah1 svelte-ynmhwm"><!></div></div></section> <div class="content-container svelte-ynmhwm"><div class="paragraph-1 svelte-ynmhwm"><p class="lead svelte-ynmhwm">BPs green rebrand in the 2000s represented the companies shift "Beyond Petroleum". 
			...
			them.</p></div></div> <section id="s-origins" class="svelte-ynmhwm"><div class="makeover-paragraph svelte-ynmhwm"><div class="paragraph-2 svelte-ynmhwm"><p class="svelte-ynmhwm">In the 15 years leading to 2000, climate change went mainstream.
				...
				willing to be misled.</p></div></div></section>`,1);function ne(_,A){D(A,!1);let p=z(!1);k(()=>{const d=document.querySelector(".title");if(d){const s=d.getBoundingClientRect().top,n=window.innerHeight;s<n*.75&&V(p,!0)}const a=()=>{const s=document.querySelectorAll(".fadein-scroll"),n=new Set;s.forEach((r,G)=>{if(n.has(r))return;const S=r.getBoundingClientRect().top,q=window.innerHeight;S<q*.5&&(r.classList.add("visible"),n.add(r),n.size===s.length&&window.removeEventListener("scroll",a))})};return window.addEventListener("scroll",a),a(),()=>{window.removeEventListener("scroll",a)}}),k(async()=>{typeof window<"u"&&(await H(()=>import("../chunks/CvEQ06TD.js").then(a=>a.l),[],import.meta.url)).default}),F();var g=j(),o=W(g),f=e(o),l=e(f),T=e(l);t(l);var w=i(l,2),I=e(w);J(I,{}),t(w),t(f),t(o);var y=i(o,4),v=e(y),b=e(v),h=i(e(b),2),x=i(e(h),4);m(x,"src",`${u??""}/colchart-climateawareness.png`),t(h);var c=i(h,4),E=e(c);m(E,"src",`${u??""}/BP_baby_ad.gif`),P(2),t(c);var B=i(c,8),M=i(e(B),4);m(M,"src",`${u??""}/six-americas.png`),t(B),P(10),t(b),t(v),t(y),$(()=>O(T,`title ${(N(p)?"visible":"")??""} svelte-ynmhwm`)),L(_,g),R()}export{ne as component};
