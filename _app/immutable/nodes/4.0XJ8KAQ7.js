import{_ as O}from"../chunks/C1FmrZbK.js";import{a as L,t as N}from"../chunks/DGqtx0UH.js";import"../chunks/BzWc-8pQ.js";import{g as z,T as F,V as W,i as q,m as $,l as e,n as t,k as i,W as g,o as G,j as J}from"../chunks/5lW7ABz8.js";import{s as r}from"../chunks/D0lOji1P.js";import{s as j}from"../chunks/Bjzgw3R-.js";import{i as V}from"../chunks/0IwTZHX3.js";import{o as A}from"../chunks/tLbPkKgv.js";import{b as l}from"../chunks/DOsWwU7K.js";import{A as U}from"../chunks/Laa9MhVm.js";var Q=N(`<section id="hero"><div class="animated-header svelte-w06wel"><div class="title-container svelte-w06wel"><h1>The <br> Aesthetics <br> of Inaction: <br> BP's Story</h1></div> <div class="ah1 svelte-w06wel"><!></div></div></section> <div class="content-container svelte-w06wel"><div class="paragraph-1 svelte-w06wel"><p class="lead svelte-w06wel">BPs 2000s marketing campaign, aptly titled "Beyond Petroleum", 
			...
			similar tactics to decieve them.</p></div></div> <section id="s-origins" class="svelte-w06wel"><div class="makeover-paragraph svelte-w06wel"><div class="paragraph-2 svelte-w06wel"><p class="svelte-w06wel">In the 15 years leading to 2000, climate change went mainstream.
				...
				manicured exterior.</p> <h3 class="references svelte-w06wel">References</h3> <p class="svelte-w06wel">1) Nisbet, M. C., & Myers, T. A. (2007). The polls–trends:
				...
				Office.</p></div></div></section>`,1);function re(T,S){z(S,!1);let m=G(!1);A(()=>{const u=document.querySelector(".title");if(u){const n=u.getBoundingClientRect().top,s=window.innerHeight;n<s*.75&&$(m,!0)}const a=()=>{const n=document.querySelectorAll(".fadein-scroll"),s=new Set;n.forEach((o,Y)=>{if(s.has(o))return;const R=o.getBoundingClientRect().top,D=window.innerHeight;R<D*.5&&(o.classList.add("visible"),s.add(o),s.size===n.length&&window.removeEventListener("scroll",a))})};return window.addEventListener("scroll",a),a(),()=>{window.removeEventListener("scroll",a)}}),A(async()=>{typeof window<"u"&&(await O(()=>import("../chunks/CvEQ06TD.js").then(a=>a.l),[],import.meta.url)).default}),V();var f=Q(),c=F(f),v=e(c),d=e(v),E=e(d);t(d);var y=i(d,2),x=e(y);U(x,{}),t(y),t(v),t(c);var b=i(c,4),B=e(b),P=e(B),h=i(e(P),2),I=i(e(h),4);r(I,"src",`${l??""}/colchart-climateawareness.png`),t(h);var p=i(h,4),C=e(p);r(C,"src",`${l??""}/BP_baby_ad.gif`),g(2),t(p);var w=i(p,2),k=e(w),H=e(k);r(H,"src",`${l??""}/bp_old_logo.jpg`),g(2),t(k),t(w);var _=i(w,8),M=i(e(_),4);r(M,"src",`${l??""}/six-americas.png`),t(_),g(34),t(P),t(B),t(b),W(()=>j(E,`title ${(J(m)?"visible":"")??""} svelte-w06wel`)),L(T,f),q()}export{re as component};
