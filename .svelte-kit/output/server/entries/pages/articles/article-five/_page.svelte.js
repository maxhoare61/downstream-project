...
function _page($$payload, $$props) {
  push();
  $$payload.out += `<section id="hero"><div class="animated-header svelte-w06wel"><div class="title-container svelte-w06wel"><h1${attr("class", `title ${stringify("")} svelte-w06wel`)}>The <br> Aesthetics <br> of Inaction: <br> BP's Story</h1></div> <div class="ah1 svelte-w06wel">`;
  AnimatedHeader1($$payload);
  $$payload.out += `<!----></div></div></section> <div class="content-container svelte-w06wel"><div class="paragraph-1 svelte-w06wel"><p class="lead svelte-w06wel">BPs 2000s marketing campaign, aptly titled "Beyond Petroleum",
			...
			for it.</p></div></div> <section id="s-origins" class="svelte-w06wel"><div class="makeover-paragraph svelte-w06wel"><div class="paragraph-2 svelte-w06wel"><p class="svelte-w06wel">In the 15 years leading to 2000, climate change went mainstream.
				...
				reaching all time highs.</p> <figure class="bar-chart svelte-w06wel"><figcaption class="caption lead svelte-w06wel">Most people heard about climate change for the first time in
					...
					Myers (2007)</figcaption> <img${attr("src", `${stringify(base)}/colchart-climateawareness.png`)} alt="Bar chart of climate awareness increasing in the 2000s" class="bar-chart-img svelte-w06wel"></figure> <p class="svelte-w06wel">Around this time, petrol titan BP suddenly, radically, reworked
				...
				choosing.</p> <figure class="svelte-w06wel"><img${attr("src", `${stringify(base)}/BP_baby_ad.gif`)} alt="BP video ad"> <figcaption>BP's "Babies" TV ad was aired in 2007.</figcaption></figure> <div class="old_logo_container svelte-w06wel"><figure class="svelte-w06wel"><img class="old_logo svelte-w06wel"${attr("src", `${stringify(base)}/bp_old_logo.jpg`)} alt="BPs old logo prior to rebrand"> <figcaption>BP's logo prior to 1997 had none of the floral
				...
				until people forgot all about it.</p> <p class="svelte-w06wel">BP realised that this strategy was deeply flawed. Denying their
				...
				for change.</p> <figure class="bar-chart svelte-w06wel"><figcaption class="caption lead svelte-w06wel">Most people wanted to see something done about climate
					...
					look like.</figcaption> <img${attr("src", `${stringify(base)}/six-americas.png`)} alt="Bar chart of climate awareness increasing in the 2000s" class="bar-chart-img svelte-w06wel"></figure> <p class="svelte-w06wel">While other companies would flounder against the rising wave of
