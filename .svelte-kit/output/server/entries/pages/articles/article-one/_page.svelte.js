...
function _page($$payload, $$props) {
  push();
  $$payload.out += `<section id="hero"><div class="animated-header svelte-1xlj5yl"><div${attr("class", `title ${stringify("")} svelte-1xlj5yl`)}>Why don’t <br> we talk about <br> the carbon <br> footprint <br> anymore?</div> <div class="ah1 svelte-1xlj5yl">`;
  AnimatedHeader1($$payload);
  $$payload.out += `<!----></div></div> <div class="content-container svelte-1xlj5yl"><div class="twitter-tweet"><div${attr("class", `tweet-card fadein-scroll bp ${stringify("")} svelte-1xlj5yl`)}><div class="creator-container svelte-1xlj5yl"><div class="tweet creator svelte-1xlj5yl">bp <br> <span class="handle svelte-1xlj5yl">@bp_plc</span></div></div> <div class="tweet content svelte-1xlj5yl"><div>The first step to reducing your emissions is to know
						where you stand. Find out your <span class="hashtag svelte-1xlj5yl">#carbonfootprint</span> with our new calculator &amp; share your pledge today!</div></div> <div class="tweet info svelte-1xlj5yl">Comment / 419 Likes / <a class="tweet source svelte-1xlj5yl" href="https://x.com/andrwfhenderson/status/1187386101960454146" target="_blank">Source</a></div></div> <div${attr("class", `tweet-card fadein-scroll ah ${stringify("")} svelte-1xlj5yl`)}><div class="creator-container svelte-1xlj5yl"><div class="tweet creator svelte-1xlj5yl">Andrew Henderson <br> <span class="handle svelte-1xlj5yl">@andrwfhenderson</span></div></div> <div class="tweet content svelte-1xlj5yl"><div><span class="hashtag svelte-1xlj5yl">@bp_plc</span> I pledge not to spill
						4.9 million barrels of oil into the gulf of mexico</div></div> <div class="tweet info svelte-1xlj5yl">Comment / 57k Likes / <a class="tweet source svelte-1xlj5yl" href="https://x.com/andrwfhenderson/status/1187386101960454146" target="_blank">Source</a></div></div> <div${attr("class", `tweet-card fadein-scroll jc ${stringify("")} svelte-1xlj5yl`)}><div class="creator-container svelte-1xlj5yl"><div class="tweet creator svelte-1xlj5yl">jodie c <span class="handle svelte-1xlj5yl">@jod_coll</span></div></div> <div class="tweet content svelte-1xlj5yl"><div>Listen, we are all to blame for the climate crisis. Some
						...
						greenhouse gasses produced.</div></div> <div class="tweet info svelte-1xlj5yl">Comment / 46k Likes / <a class="tweet source svelte-1xlj5yl" href="https://x.com/jodcoll/status/1424692518273392642" target="_blank">Source</a></div></div> <div${attr("class", `tweet-card fadein-scroll shell ${stringify("")} svelte-1xlj5yl`)}><div class="creator-container svelte-1xlj5yl"><div class="tweet creator svelte-1xlj5yl">Shell <span class="handle svelte-1xlj5yl">@shell</span></div></div> <div class="tweet content svelte-1xlj5yl"><div>📊 What are you willing to change to help reduce
						emissions? #EnergyDebate <br> 1) 💨 offset emissions <br> 2) ✈️ stop flying <br> 3) 🚗 buy electric vehicle <br> 4) ⚡️ renewable electricity</div></div> <div class="tweet info svelte-1xlj5yl">Comment / 869 Likes / <a class="tweet source svelte-1xlj5yl" href="https://x.com/Shell/status/1323184318735360001" target="_blank">Source</a></div></div></div> <div class="paragraph-1 svelte-1xlj5yl"><p class="lead svelte-1xlj5yl">The carbon footprint reached levels of stardom in the 2000s
				...
				come to pass, however, remained uncertain for now.</p> <figure class="bar-chart svelte-1xlj5yl"><figcaption class="caption lead svelte-1xlj5yl">Most people heard about climate change for the first time in
					...
					Collated by Nisbet and Myers (2007)</figcaption> <img${attr("src", `${stringify(base)}/colchart-climateawareness.png`)} alt="Bar chart of climate awareness increasing in the 2000s" class="bar-chart-img svelte-1xlj5yl"></figure> <p class="svelte-1xlj5yl">Around the same time, petrol behemoth BP suddenly, radically,
				...
				BP would be the first oil company in history to “go green”.</p> <p class="svelte-1xlj5yl">BPs green transformation resonated with people’s desire to see
				...
				environmentally friendly oil company” .</p> <p class="svelte-1xlj5yl">While Frutiger Aero aesthetics and witty newspaper ads were
				...
				largest oil spill in human history.</p> <figure class="svelte-1xlj5yl"><img${attr("src", `${stringify(base)}/BP-Logo-history.jpg`)} alt="The progression of BPs logo since the 1960s" class="campaign-image svelte-1xlj5yl"> <figcaption>The progression of BP's logo since the 1960s (1000 Logos)</figcaption></figure> <figure class="svelte-1xlj5yl"><img${attr("src", `${stringify(base)}/bp-cf-ads.jpg`)} alt="BP's Advertising Campaign" class="campaign-image svelte-1xlj5yl"> <figcaption>BP's 'green' campaign from 2005 (source: BP)</figcaption></figure></div></div></section> <div class="content-container svelte-1xlj5yl"><section id="s-origins" class="svelte-1xlj5yl"><div class="makeover-paragraph svelte-1xlj5yl"><h2 class="svelte-1xlj5yl">How the Carbon Footprint Changed How You Think About Climate
