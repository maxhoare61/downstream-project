import { Q as pop, W as stringify, O as push } from "../../../../chunks/index.js";
import { b as base } from "../../../../chunks/paths.js";
import { A as AnimatedHeader1 } from "../../../../chunks/AnimatedHeader1.js";
import { a as attr } from "../../../../chunks/attributes.js";
function _page($$payload, $$props) {
  push();
  $$payload.out += `<section id="hero"><div class="animated-header svelte-17y4j1m"><div${attr("class", `title ${stringify("")} svelte-17y4j1m`)}>Why don’t <br> we talk about <br> the carbon <br> footprint <br> anymore?</div> <div class="ah1 svelte-17y4j1m">`;
  AnimatedHeader1($$payload);
  $$payload.out += `<!----></div></div> <div class="content-container svelte-17y4j1m"><div class="twitter-tweet"><div${attr("class", `tweet-card fadein-scroll bp ${stringify("")} svelte-17y4j1m`)}><div class="creator-container svelte-17y4j1m"><div class="tweet creator svelte-17y4j1m">bp <br> <span class="handle svelte-17y4j1m">@bp_plc</span></div></div> <div class="tweet content svelte-17y4j1m"><div>The first step to reducing your emissions is to know
						where you stand. Find out your <span class="hashtag svelte-17y4j1m">#carbonfootprint</span> with our new calculator &amp; share your pledge today!</div></div> <div class="tweet info svelte-17y4j1m">Comment / 419 Likes / <a class="tweet source svelte-17y4j1m" href="https://x.com/andrwfhenderson/status/1187386101960454146" target="_blank">Source</a></div></div> <div${attr("class", `tweet-card fadein-scroll ah ${stringify("")} svelte-17y4j1m`)}><div class="creator-container svelte-17y4j1m"><div class="tweet creator svelte-17y4j1m">Andrew Henderson <br> <span class="handle svelte-17y4j1m">@andrwfhenderson</span></div></div> <div class="tweet content svelte-17y4j1m"><div><span class="hashtag svelte-17y4j1m">@bp_plc</span> I pledge not to spill
						4.9 million barrels of oil into the gulf of mexico</div></div> <div class="tweet info svelte-17y4j1m">Comment / 57k Likes / <a class="tweet source svelte-17y4j1m" href="https://x.com/andrwfhenderson/status/1187386101960454146" target="_blank">Source</a></div></div> <div${attr("class", `tweet-card fadein-scroll jc ${stringify("")} svelte-17y4j1m`)}><div class="creator-container svelte-17y4j1m"><div class="tweet creator svelte-17y4j1m">jodie c <span class="handle svelte-17y4j1m">@jod_coll</span></div></div> <div class="tweet content svelte-17y4j1m"><div>Listen, we are all to blame for the climate crisis. Some
						...
						greenhouse gasses produced.</div></div> <div class="tweet info svelte-17y4j1m">Comment / 46k Likes / <a class="tweet source svelte-17y4j1m" href="https://x.com/jodcoll/status/1424692518273392642" target="_blank">Source</a></div></div> <div${attr("class", `tweet-card fadein-scroll shell ${stringify("")} svelte-17y4j1m`)}><div class="creator-container svelte-17y4j1m"><div class="tweet creator svelte-17y4j1m">Shell <span class="handle svelte-17y4j1m">@shell</span></div></div> <div class="tweet content svelte-17y4j1m"><div>📊 What are you willing to change to help reduce
				...
				come to pass, however, remained uncertain for now.</p> <figure class="bar-chart svelte-17y4j1m"><figcaption class="caption lead svelte-17y4j1m">Most people heard about climate change for the first time in
					...
					Collated by Nisbet and Myers (2007)</figcaption> <img${attr("src", `${stringify(base)}/colchart-climateawareness.png`)} alt="Bar chart of climate awareness increasing in the 2000s" class="bar-chart-img svelte-17y4j1m"></figure> <p class="svelte-17y4j1m">Around the same time, petrol behemoth BP suddenly, radically,
				...
				largest oil spill in human history.</p> <figure class="svelte-17y4j1m"><img${attr("src", `${stringify(base)}/BP-Logo-history.jpg`)} alt="The progression of BPs logo since the 1960s" class="campaign-image svelte-17y4j1m"> <figcaption>The progression of BP's logo since the 1960s (1000 Logos)</figcaption></figure> <figure class="svelte-17y4j1m"><img${attr("src", `${stringify(base)}/bp-cf-ads.jpg`)} alt="BP's Advertising Campaign" class="campaign-image svelte-17y4j1m"> <figcaption>BP's 'green' campaign from 2005 (source: BP)</figcaption></figure></div></div></section> <div class="content-container svelte-17y4j1m"><section id="s-origins" class="svelte-17y4j1m"><div class="makeover-paragraph svelte-17y4j1m"><h2 class="svelte-17y4j1m">How the Carbon Footprint Changed How You Think About Climate
				Change</h2> <div class="paragraph-2 svelte-17y4j1m"><p class="svelte-17y4j1m">For companies like BP, the carbon footprint calculator was
					...
					climate change in terms of its true causes.</p></div></div></section></div>`;
  pop();
}
export {
  _page as default
