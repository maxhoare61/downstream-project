...
function _page($$payload, $$props) {
  push();
  $$payload.out += `<section id="hero"><div class="animated-header svelte-y8pqsn"><div class="title-container svelte-y8pqsn"><h1${attr("class", `title ${stringify("")} svelte-y8pqsn`)}>The <br> Aesthetics <br> of Inaction: <br> BP's Story</h1></div> <div class="ah1 svelte-y8pqsn">`;
  AnimatedHeader1($$payload);
  $$payload.out += `<!----></div></div></section> <div class="content-container svelte-y8pqsn"><div class="paragraph-1 svelte-y8pqsn"><p class="tile-description i svelte-y8pqsn"><strong>Maxwell Hoare</strong></p> <p class="lead svelte-y8pqsn">BPs 2000s marketing campaign, aptly titled "Beyond Petroleum",
			...
			fatalities at BP facilities left people scrambling for answers.</p></div></div> <section id="s-origins" class="svelte-y8pqsn"><div class="makeover-paragraph svelte-y8pqsn"><div class="paragraph-2 svelte-y8pqsn"><p class="svelte-y8pqsn">In the 15 years leading to 2000, climate change went mainstream.
				...
				reaching all time highs.</p> <figure class="bar-chart svelte-y8pqsn"><figcaption class="caption lead svelte-y8pqsn">Most people heard about climate change for the first time in
					...
					Myers (2007)</figcaption> <img${attr("src", `${stringify(base)}/colchart-climateawareness.png`)} alt="Bar chart of climate awareness increasing in the 2000s" class="bar-chart-img svelte-y8pqsn"></figure> <p class="svelte-y8pqsn">Around this time, petrol titan BP suddenly, radically, reworked
				...
				choosing.</p> <figure class="svelte-y8pqsn"><img${attr("src", `${stringify(base)}/BP_baby_ad.gif`)} alt="BP video ad"> <figcaption>BP's "Babies" TV ad was aired in 2007.</figcaption></figure> <div class="old_logo_container svelte-y8pqsn"><figure class="svelte-y8pqsn"><img class="old_logo svelte-y8pqsn"${attr("src", `${stringify(base)}/bp_old_logo.jpg`)} alt="BPs old logo prior to rebrand"> <figcaption>BP's logo prior to 1997 had none of the floral
				...
				for change.</p> <figure class="bar-chart svelte-y8pqsn"><figcaption class="caption lead svelte-y8pqsn">Most people wanted to see something done about climate
					...
					look like.</figcaption> <img${attr("src", `${stringify(base)}/six-americas.png`)} alt="Bar chart of climate awareness increasing in the 2000s" class="bar-chart-img svelte-y8pqsn"></figure> <p class="svelte-y8pqsn">While other companies would flounder against the rising wave of
