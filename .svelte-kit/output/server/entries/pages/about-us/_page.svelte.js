...
function _page($$payload) {
  $$payload.out += `<div class="content-container svelte-v8qyn5"><h1 class="title svelte-v8qyn5">About Us</h1> <div class="top-section svelte-v8qyn5"><div class="paragraph-2 svelte-v8qyn5"><p class="svelte-v8qyn5">Downstream Project is an independent research platform focused
				...
				that invites exploration.</p></div></div></div>`;
}
export {
  _page as default
};
