...
function _page($$payload) {
  $$payload.out += `<div class="content-container svelte-10stq9l"><h1 class="title svelte-10stq9l">About Us</h1> <div class="top-section svelte-10stq9l"><div class="section-left svelte-10stq9l"><div class="lead svelte-10stq9l">At Downstream, we believe public data should be truly public.</div> <div class="body-text svelte-10stq9l"><p>However, important insights often sit buried in fragmented government databases and
					...
					you understand the full picture. Our mission is to help the public use data to make informed decisions on important issues. <br></p></div></div> <div class="section-right svelte-10stq9l"><img src="/about-us.jpg" alt="Impressionist painting of a mining site"> <p class="caption svelte-10stq9l">Our mission is to create a world where the public feels empowered to make decisions on issues affecting themselves and the environment (source: Imagen 3 AI)</p></div></div> `;
  WhatWeDo($$payload);
  $$payload.out += `<!----></div>`;
}
export {
